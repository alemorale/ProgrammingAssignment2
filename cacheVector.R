## Prototypes: Caching the Mean of a Vector
## This functions are the prototypes used for Assingment 2.
...
## Thefirst function, makeVector creates a special "vector" object
